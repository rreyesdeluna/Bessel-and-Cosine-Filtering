...
fig.update_traces(line = dict(width = 8, color = 'black'))
...
for i in range(modes):
    freq_av, damp_av = ht.hilbert_transform(t = tres, st = iires[i,:], fs = fs, index = str(i + 1), print_chart = 1, save_fig = 'hilbert_' + str(i))
