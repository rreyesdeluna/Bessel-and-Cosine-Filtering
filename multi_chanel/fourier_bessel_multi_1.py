...
fft_chart.multisignal_FFT(t_vec = t, y_vec = st, h_vec = ['s1', 's2', 's3'], x_axis = [0, 1.2], save_fig = 'fft1')
sys.exit()
#########################################################################################
# SEVERAL FREQUENCIES OF BESSEL FUNCTIONS
...
# fig.write_image("bessel_func.png")
# #fig.show()
